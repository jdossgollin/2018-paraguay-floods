...
\begin{frame}{}
  \begin{columns}[t]
    ...
    \begin{column}{0.22\linewidth}
        ...
        \input{blocks/observations-wts.tex}
    ...
    \begin{column}{0.22\linewidth}
      ...
      \input{blocks/observed-anomalies.tex}
    ...
    \begin{column}{0.22\linewidth}
      ...
      \input{blocks/s2s-forecasts.tex}
      \input{blocks/model-output-stats.tex}
    ...
    \begin{column}{0.22\linewidth}
      ...
      \input{blocks/mjo-enso.tex}
      \input{blocks/atlantic-pacific.tex}
